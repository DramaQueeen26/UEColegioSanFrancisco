<!-- Contenido principal de la pagina -->
		<div class="container-fluid">
			...
			<p class="lead">Puede añadir más administradores en este apartado</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	<li class="active"><a href="#new" data-toggle="tab">Nuevo Admin</a></li>
					  	<li><a href="#list" data-toggle="tab">Administradores</a></li>
					</ul>
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="<?=$baseUrl?>admin/admin/" method="post">
